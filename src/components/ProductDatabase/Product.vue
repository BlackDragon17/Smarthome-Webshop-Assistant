<template>
    <div class="product-container">
        <article class="product-card">
            ...
            <button v-if="!homeSetupNoRooms" class="add-product-button btn btn-success relative-centering" @click="getNewProduct">
                {{ replaceId ? "Choose product" : "Add to home setup" }}
            </button>
            <div v-if="!homeSetupNoRooms" class="spacer btn btn-success" disabled>Spacer</div>
        </article>
    </div>
</template>
